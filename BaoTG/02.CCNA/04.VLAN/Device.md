...
## MODEM (Bộ điều giải)
**Khái niệm:**
- Modem là kết hợp của hai từ Modulator và Demodulator có nghĩa là thiết bị mã hóa và giải mã các xung điện. Modem là thiết bị giao tiếp với mạng lưới của các nhà cung cấp dịch vụ Internet (ISP), chẳng hạn như FPT Telecom, Viettel,... thành tín hiệu kỹ thuật số, thông qua hệ thống cáp nối đồng trục, cáp quang hay đường dây điện thoại (DSL). Đây chính là cánh cổng để giúp bạn kết nối với Internet quốc tế.
...
![Network Card](./images/network_card.png)
## BRIDGE
